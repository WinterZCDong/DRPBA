...
public class BBS {
    public static void main(String[] args) {
        ...
        System.out.println("System initial time:"+timeInitialize/(1e6)+"ms");
        ...
        System.out.print("administor private key:");
        System.out.print('(');
...
//        System.out.println(A);
        ...
        System.out.println("private key generate time:"+timeGenKey/(1e6)+"ms");
...
//        System.out.println(fu_r_alpha.sub(r_beta));
        ...
        System.out.println("sign time:"+timeSign/(1e6)+"ms");
        ...
        System.out.println("verify time:"+timeVerify/(1e6)+"ms");
